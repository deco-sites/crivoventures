...
export default function Main(props: Props) {
  ...
  return (
    <div class="max-w-[1200px] mx-auto flex md:flex-row flex-col md:justify-between items-center pb-[3.3vmax] lg:top-[101.766px] top-[145.721px] relative z-0 md:pl-[40px]">
